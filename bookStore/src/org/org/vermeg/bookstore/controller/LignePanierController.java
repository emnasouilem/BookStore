...
public class LignePanierController {
	...
	@RequestMapping(value = "/getAllLignePanier/{id}", method = RequestMethod.GET, headers = "Accept=application/json")
	public List<LignePanier> getPanier(@PathVariable int id) {
	...
	public String addLignePanier(@ModelAttribute("panier") LignePanier lpanier) {	
